<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Overviewtest.aspx.cs" Inherits="ServicePoint.Test.Overviewtest" %>

<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <form id="frm" runat="server" enableviewstate="false">

        <div>
            <div class="col-md-7 col-lg-7 contents">
                        ...
                        <Columns>
                                    ...
                                    <div class="text-small nopadding container-fluid">
                                        <div class="row-fluid">
                                            <div class="col-md-12 nopadding ">
                                                ...
                                                <div class="col-md-6 text-right  nopadding "><%# ServicePoint.Lib.Util.ConvertToFileSizeWitFormatWithNullCheck( Eval("Utilization") ) %></div>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
                            ...
                            <asp:TemplateField HeaderText="Committed">
                                <ItemTemplate>
                                    <div class="progress progress-striped active" style="margin-top: 45px; width: 100px;">
                                        <div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: <%# ServicePoint.Lib.Util.GetRate( (Convert.ToDouble(Eval("Committed"))/(1024*1024)) , (Convert.ToDouble(Eval("RAMSize"))/(1024*1024) )) %>%">
                                        </div>
                                        <div class="progress-bar progress-bar-warning" style="width: <%# (100-ServicePoint.Lib.Util.GetRate( (Convert.ToDouble(Eval("Committed"))/(1024*1024)) , (Convert.ToDouble(Eval("RAMSize"))/(1024*1024) ))) %>%"></div>
                                    </div>
                                    <div class="text-center">
                                        <%# ServicePoint.Lib.Util.FuncMemoryValue(Convert.ToDouble(Eval("Committed")),"Committed")%>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Available">
                                <ItemTemplate>
                                    ...
                                    <div class="progress progress-striped active" style="margin-top: 45px; width: 100px;">
                                        <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: <%# ServicePoint.Lib.Util.GetRate(Convert.ToDouble(Eval("Available")), Convert.ToDouble(Eval("RAMSize") )/(1024*1024)) %>%">
                                        </div>
                                        <div class="progress-bar progress-bar-warning" style="width: <%# (100-ServicePoint.Lib.Util.GetRate(Convert.ToDouble(Eval("Available")), Convert.ToDouble(Eval("RAMSize") )/(1024*1024))) %>%"></div>
                                    </div>
                                    <div class="text-center">
                                        <%# ServicePoint.Lib.Util.FuncMemoryValue(Convert.ToDouble(Eval("Available")),"Available")%>
                                    </div>
                                ...
                                <ItemTemplate>
                                    <div class="text-small nopadding container-fluid">
                                        <div class="row-fluid">
                                            <div class="col-md-12 nopadding ">
                                                <div class="col-md-6 text-left nopadding ">100</div>
                                                <div class="col-md-6 text-right  nopadding "><%#ServicePoint.Lib.Util.ConvertToFileSizeWitFormatWithNullCheck( Eval("DiskSpeed") ) %></div>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
                                    ...
                                    <div class="text-small nopadding container-fluid">
                                        <div class="row-fluid">
                                            <div class="col-md-12 nopadding ">
                                                ...
                                                <div class="col-md-6 text-right  nopadding "><%#  Math.Round(Convert.ToDouble(Eval("NetworkBytes"))/(1024*1024),2).ToString()  %>MB</div>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
