    ...
    <div class="row-fluid">
        <nav id="navid" class="navbar navbar-inverse" role="navigation">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="/Default.aspx">ServicePoint</a>
            </div>
            <!-- //모바일 화면에서 메뉴라인 표시 -->
            <!-- 메뉴 -->
            <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                <ul class="nav navbar-nav navbar-left">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-th"></i>Service Point <sup>2.0</sup><span class="caret"></span></a>
                    ...
                    <li class="line-vertical"><a href="/OverView/Serveroverview.aspx">Servers Overview</a></li>
                    <li><a href="/Overview/WebOverview.aspx">Web Servers</a></li>
                    <li><a href="/Overview/SqlOverview.aspx">Sql Servers</a></li>
                    <li class="line-vertical"><a href="/Report/Win_PerformanceReport.aspx"><i class="fa fa-file-text"></i>Reports</a></li>
                    <li><a href="/Setting/GroupMember.aspx"><i class="fa fa-gear"></i>Settings</a></li>

                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li class="line-vertical"><a href="/Setting/user.aspx"><i class="fa fa-user"></i><%= strUserEmail %></a></li>
                    <li class="line-vertical"><a href="/login/logout.aspx"><i class="fa fa-sign-out"></i>Logout</a></li>
                </ul>
            </div>
            <!-- //메뉴 -->
