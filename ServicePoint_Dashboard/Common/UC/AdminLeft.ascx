...
<asp:Panel ID="pnl_Report" runat="server" Visible="false">
    ...
    <div class="list-group" id="menuLeft">
        <a class="list-group-item active">Windows 공통</a>
        <a href="/Report/Win_PerformanceReport.aspx" class="list-group-item" id="winperformence">성능 분석 보고서</a>
        <a href="/Report/Win_CounterReport.aspx" class="list-group-item" id="wincounter">성능 카운터 조회</a>
        ...
        <a href="/Report/SQL_Cpu.aspx" class="list-group-item" id="sqlcpu">SQL CPU</a>
